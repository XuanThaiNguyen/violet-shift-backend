const { fetchCollections, createIndexIfNotExists, createCollectionIfNotExists } = require('../migration-helpers');
  ...
  async up(db, client) {
    ...
    await createCollectionIfNotExists(db, collections, 'shifts', {
      ...
      properties: {
        shiftType: {
          bsonType: 'string',
          enum: ['personal_care', 'board_n_lodging', 'domestic_assistance', 'night_shift', 'on_call', 'recall_to_work', 'remote_work', 'respite_care', 'sleepover', 'support_coordination', 'transport', '24_hour_care'],
    ...
    await createCollectionIfNotExists(db, collections, 'staff_schedules', {
      ...
      properties: {
        ...
        clientSignatures: {
          bsonType: 'array',
          items: { bsonType: 'string' },
          description: 'Client signatures array'
        },
        isDeleted: {
          bsonType: 'bool',
          description: 'Soft delete flag'
    ...
    await createIndexIfNotExists(db, collections, 'staff_schedules', { shift: 1, staff: 1 }, { unique: true });
